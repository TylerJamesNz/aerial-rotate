...
install -m 644 -o root -g wheel "$REPO_DIR/com.aerialrotate.plist" /Library/LaunchDaemons/com.aerialrotate.plist
...
launchctl bootout system /Library/LaunchDaemons/com.aerialrotate.plist 2>/dev/null || true
launchctl bootstrap system /Library/LaunchDaemons/com.aerialrotate.plist
...
install -m 644 -o "$TARGET_USER" -g staff "$REPO_DIR/com.aerialrotate.agent.plist" "$AGENT_PLIST"
